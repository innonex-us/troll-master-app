...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_scheduled_posts_cmd,
            commands::create_scheduled_post_cmd,
            commands::delete_scheduled_post_cmd,
            ...
            commands::export_profiles_backup_cmd,
            commands::import_profiles_backup_cmd,
            commands::export_campaigns_backup_cmd,
            commands::import_campaigns_backup_cmd,
            commands::export_pods_backup_cmd,
            commands::import_pods_backup_cmd,
            commands::export_proxies_backup_cmd,
            commands::import_proxies_backup_cmd,
            commands::export_blacklist_backup_cmd,
            commands::import_blacklist_backup_cmd,
